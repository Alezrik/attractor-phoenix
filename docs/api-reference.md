...
- [AttractorPhoenix.TrustProof](AttractorPhoenix.TrustProof.md): Shared proof-packet shaping for setup and benchmark trust surfaces.
...
- [AttractorPhoenixWeb.CoreComponents](AttractorPhoenixWeb.CoreComponents.md): Shared UI primitives for the product shell.

- [AttractorPhoenixWeb.DashboardLive](AttractorPhoenixWeb.DashboardLive.md)
- [AttractorPhoenixWeb.DebuggerLive](AttractorPhoenixWeb.DebuggerLive.md)
...
- [AttractorPhoenixWeb.FailureReviewLive](AttractorPhoenixWeb.FailureReviewLive.md)
...
- [AttractorPhoenixWeb.Layouts](AttractorPhoenixWeb.Layouts.md): Shared layout primitives for the application shell.
...
- [AttractorPhoenixWeb.RunLive](AttractorPhoenixWeb.RunLive.md)
...
- [mix attractor.api](Mix.Tasks.Attractor.Api.md): Runs Noor Halden's focused AttractorEx API smoke suite without folding it into
the broader `mix test` or `mix attractor.http` loops.
- [mix attractor.http](Mix.Tasks.Attractor.Http.md): Runs the focused AttractorEx HTTP API suite without folding it into the full
`mix test` loop.
- [mix bench](Mix.Tasks.Bench.md): Runs focused benchmark scripts from `bench/` without folding them into `mix test`.
